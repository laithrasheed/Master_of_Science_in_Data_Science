...
**In this specialization I learned about database design, and how to use the Structured Query Language (SQL) to work with databases. Upon completion of this specialization I am well prepared to design and create efficient and effective relational databases, fill them with data, and work with them using SQL.**
